      ...
      <div className="hero  bg-base-200">
        <div className="hero-content flex-col lg:flex-row">
          ...
          <div>
            ...
            <p className="py-6">
              Faciliter les interactions professionnelles à travers une carte de
              visite sans contact innovante et personnalisée, tout en soutenant
              des pratiques écologiques et en adoptant les dernières avancées
              technologiques.
            </p>
          </div>
        </div>
      ...
      <ul className="timeline timeline-vertical   my-5 p-5">
        ...
        <li>
          ...
          <div className="timeline-end timeline-box">
            QR Code Intégré : Accédez facilement à vos informations complètes en
            scannant le QR code, même sans NFC.
          </div>
          <hr className="bg-primary" />
        </li>
        <li>
        ...
        <li>
          ...
          <div className="timeline-end timeline-box">
            Mise à Jour Facile : Modifiez vos informations à tout moment via une
            plateforme en ligne sécurisée, sans avoir à réimprimer la carte.
          </div>
          <hr className="bg-primary" />
        </li>
        <li>
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            ...
            <p className="py-6">
              ...
              visite sans contact, en révolutionnant les échanges professionnels
